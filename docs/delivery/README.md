...
| [oceanengine-schema-calibration.md](./oceanengine-schema-calibration.md) | 巨量平台对象语义、真实业务流、全场景覆盖矩阵、项目/单元字段骨架及内部三段映射 | Manifest 已冻结；素材替换、项目启用/暂停和单元暂停/启用已完成可逆写后回读，创建及受约束预算路径保留稳定阻塞 |
