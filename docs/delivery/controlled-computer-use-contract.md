...
fake. The remaining promotion-form and control-plane evidence work must
complete before a real adapter can be considered calibrated or production
mounting can be considered.
