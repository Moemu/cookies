...
function AssetCard({ asset, editUrl, feature, onRemove, previewUnavailable, previewUrl, projectId, view }: { asset: ProjectAsset; editUrl?: string; feature?: AssetFeature; onRemove: () => void; previewUnavailable?: boolean; previewUrl?: string; projectId: string; view: ViewMode }) {
