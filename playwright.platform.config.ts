...
export default defineConfig({
  testDir: './e2e',
  testMatch: /(platform-go-demo|strategy-brand-video-foundation|strategy-workspace-rearchitecture|delivery-plan-preflight|delivery-approval-content-hash|delivery-execution-scenarios|delivery-monitoring-alerts|delivery-three-tier|delivery-mock-tour)\.spec\.ts/,
  fullyParallel: false,
  workers: 1,
  use: {
    baseURL: webBaseURL,
