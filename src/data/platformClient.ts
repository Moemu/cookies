...
export type PlatformProjectWorkbench = {
  ...
  products: Array<{ id: string; name: string; ocean_engine_product_id?: string }>;
  ...
  asset_version_pointers: Array<{ id: string; organization_id: string; project_id: string; asset_id: string; ocean_engine_material_id?: string; working_version: number; quality_checked_version: number | null; human_confirmed_version: number | null; delivery_version: number | null; versions: Array<{ version: number; created_by: string; source_task_id: string; source_type: string; source_label: string; created_at: string; change_summary: string }>; authorization: { platforms: string[]; regions: string[]; rights_holder: string; expires_at: string; note: string }; delivery_target: { platform: string; region: string }; owner: string; updated_at: string }>;
};
